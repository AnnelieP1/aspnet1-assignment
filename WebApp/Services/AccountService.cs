...
public class AccountService(UserManager<UserEntity> userManager, ApplicationContext context, IConfiguration configuration)
{
    ...
    public async Task<bool> UpdateBasicInfoAsync(ClaimsPrincipal claimsPrincipal, AccountBasicInfoViewModel basicInfo)
    {
        try
        {
            var nameIdentifer = claimsPrincipal.FindFirst(ClaimTypes.NameIdentifier)!.Value;
    ...
    public async Task<bool> UpdateAddressInfoAsync(ClaimsPrincipal claimsPrincipal, AccountAddressInfoViewModel addressInfo)
    {
        try
        {
            var nameIdentifer = claimsPrincipal.FindFirst(ClaimTypes.NameIdentifier)!.Value;
